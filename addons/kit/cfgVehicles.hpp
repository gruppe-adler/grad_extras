...
class grad_soldier_combatFatigues_khaki_white: I_E_Uniform_01_tanktop_F
	{
		author = "Synch";
		scope = 1;   
		modelSides[]={1,2};                       // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).		
